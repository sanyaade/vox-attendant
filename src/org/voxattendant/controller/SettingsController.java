...
public class SettingsController extends BaseController {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            // Passcode
                ...
                System.out.println("SettingsController reqState: " + reqState
     ...
     */
    protected void showSettings(HttpServletRequest req, HttpServletResponse res)
    throws ServletException, IOException {
        
        ApplicationBean appBean = retrieveApplicationBean();
        OperatorBean operatorBean = retrieveOperatorBean(req);
        // //
        // System.out.println("OperatorBean:" + operatorBean);
        // //
     ...
     */
    protected void showOperatorEdit(HttpServletRequest req,
     ...
     */
    protected void processOperatorEdit(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
     ...
     */
    protected void processOperatorUpdate(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
     ...
     */
    protected void showApplicationEdit(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
     ...
     */
    protected void processApplicationEdit(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
        ...
        if (req.getParameter("save") != null) {
            ...
            phoneNumberBean
                    .setPhoneTypeId(PhoneNumberBean.PHONETYPEID_APPLICATION);
     ...
     */
    protected void processPromptDirections(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
     ...
     */
    protected void processPromptGreetings(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
        ...
        if (promptBeanList != null) {
            ...
            for (int j = 0; j < promptIds.length; j++) {
                ...
                // //
                for (int i = 0; i < promptBeanList.size(); i++) {
                    PromptBean promptBean = (PromptBean) promptBeanList
                            .getItem(i);
                    if (promptBean.getPromptId() == promptId)
                        promptBean.setActive(true);
                }
            }
     ...
     *
     */
    protected void showPasscodeEdit(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
     ...
     *
     */
    protected void processPasscodeEdit(HttpServletRequest req,
            HttpServletResponse res) throws ServletException, IOException {
        ...
        if (req.getParameter("save") != null) {
            ...
            if (oldPasscode.equals(appBean.getPasscode())
            && newPasscode.equals(newPasscode2)) {
                // Update Passcode...
                appBean.setPasscode(newPasscode);
                ApplicationManager.updateApplicationBean(appBean);
                
                errorBean.addError("Passcode has been updated.",
                        FormError.SEVERITY_STOP);
                ...
                errorBean
                        .addError(
                        "Old Passcode does not match. Failed to change passcode.",
                        FormError.SEVERITY_STOP);
                req.setAttribute("errorBean", errorBean);
    ...
    throws ServletException, IOException {
        ...
        if (newNote != null && newNote.trim().length() > 0) {
            ...
            // //
            System.out.println("Found new Note & Number: " + newNote + " : "
                    + newNumber);
            // //
        ...
        while (params.hasMoreElements()) {
            ...
            if (!data.startsWith(PREFIX_NOTE))
                continue;
     ...
     *
     */
    protected void deleteOperatorNumber(HttpServletRequest req)
    throws ServletException, IOException {
